...
export default function EvidenceTrail({ evidence = [], steps = [] }: EvidenceTrailProps) {
  ...
  return (
    <div className="theme-card p-4 sm:p-7 animate-slide-up space-y-3 shadow-lg">
      ...
      >
        <div className="flex items-center gap-2.5 sm:gap-3">
          <div className="w-8 h-8 rounded-xl bg-[#22B8CF]/15 flex items-center justify-center text-[#158091] shrink-0 shadow-xs">
            <Layers className="w-4 h-4" />
          </div>
          <div>
            <h3 className="font-heading text-base sm:text-lg font-bold text-[#1C2740] group-hover:text-[#22B8CF] transition-colors flex items-center gap-2">
        ...
        <div className={`w-8 h-8 rounded-xl bg-slate-100 flex items-center justify-center text-slate-600 group-hover:bg-[#22B8CF] group-hover:text-white transition-all duration-300 shrink-0 ${isOpen ? 'bg-[#22B8CF] text-white' : ''}`}>
        ...
        <div className="overflow-hidden space-y-4">
          <div className="border-t border-slate-200/80 pt-3 space-y-4">
            ...
            {steps && steps.length > 0 && (
              <div className="p-3 sm:p-4 rounded-xl bg-slate-50 border border-slate-200/90">
              ...
              <div className="space-y-3">
                {evidence.map((item, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="p-3.5 sm:p-4 rounded-xl bg-white border border-slate-200/90 hover:border-[#22B8CF] transition-all duration-200 shadow-xs space-y-2.5"
                    >
                      ...
                      {item.reason && (
                        <div className="text-[11px] sm:text-xs text-[#1C2740] bg-slate-50/90 rounded-lg p-2.5 border border-slate-100 leading-relaxed">
